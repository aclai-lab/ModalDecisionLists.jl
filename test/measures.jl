using Test
using ModalDecisionLists.Metrics: significance_test
...
@testset "Tests for significance_test" begin
    a = createsampling([11  0  0])
    b = createsampling([50 50 50])
    @test significance_test(a,b, 0.1, nlabels=3) == true
    ...
    @test significance_test(a,b, 0.1, nlabels=3) == false
    ...
    a = createsampling([ 0 11  1])
    b = createsampling([ 0 50 50])
    @test_nowarn significance_test(a,b, 0.0, nlabels=3)
    @test_nowarn significance_test(a,b, 1.0, nlabels=3)
end